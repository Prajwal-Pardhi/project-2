...
const Index_3 = () => {
  const heading=["Zudio continues to expand its footprint.", 
    "Shein faces challenges in IPO plans", 
    "MarcoWagon redefines women's fast fashion"];
    const imgPath = [
        ["/blogImages/Index_3/img1.1.png"], 
        ["/blogImages/Index_3/img2.1.png", ], 
        ["/blogImages/Index_3/img3.1.png", "/blogImages/Index_3/img3.2.png"]
    ];
    const content = [
